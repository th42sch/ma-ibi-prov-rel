...
The first type is that of \mybold{substitute information}, which was discussed
...
\mybold{Complex relationships} have already been mentioned in
Sections~\ref{subsec:insights_from_SoNAR} and~\ref{sec:manual_vs_automated}.
For example, the relationship \enquote{$P_1$ and $P_2$ are students of the same scholar}
between two persons $P_1$ and $P_2$ is not explicit in the data.
