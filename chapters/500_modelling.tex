...
as the query. In more formal words, answers are found using a \emph{pattern matching} technique
...
The basic components of a graph are nodes and edges. Edges link nodes and can be directed
