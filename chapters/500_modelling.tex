...
\todo[think,inline]{Refer to description logic terminology regarding the terms \enquote{object}, \enquote{concept}, \enquote{relation}, \emph{instance}, etc.? Distinguish clearly between \enquote{relation} and \enquote{relationship}.}
...
Edges represent relationships between objects or literals, which are typically directed:
