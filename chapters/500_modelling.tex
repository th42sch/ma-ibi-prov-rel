...
Query patterns~\exaquery{3} and~\exaquery{8} include references to \emph{sets} of objects:
%
\begin{enumerate}
  \item[\exaquery{3}]
...
\end{enumerate}
%
It is tempting to model~\exaquery{8} according to the basic model,
as shown in Figure~\ref{fig:modelling_Q8}.
However, if 
