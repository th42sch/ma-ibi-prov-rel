...
%  \item
    ...
    because $G''$ can be reconstructed from $G$ and $h$. However, we deliberately make $G''$ explicit
...
but for the relationships \todo{between} from these objects to person $X$.
