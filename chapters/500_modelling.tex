...
\todo[defer,inline]{Adapt the following paragraph when this chapter is finished.}
...
can be represented via pairs of edges pointing into both directions.
...
%  \item
    ...
    This situation is shown in Figure~\ref{fig:example_answer}.
...
\begin{figure}[ht]
  ...
  \end{tikzpicture}
  %  
  \todo[defer,inline]{Use straight lines (with 90° angles) for all edges? Gray out query and say so in the text?}
