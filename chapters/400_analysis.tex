...
into the \gls{BIBFRAME} format, but the state of this project after 2014
...
\gls{T-PRO} (see Section~\ref{sec:provenance_indexing}). As of 2014,
...
This field provides subfields for the structured recording of T-PRO terms.
...
There is, however, no guarantee as to whether temporal data of this kind is recorded exhaustively,
and our tentative inspections of individual authority records suggest that some kinds of temporal data,
such as the time of studentship, tend to be omitted by default.
...
\par\bigskip
\todo[inline]{If there is time left, then also describe: Proveana, ZDB, KPE, Europeana, WorldCat, KVK}
