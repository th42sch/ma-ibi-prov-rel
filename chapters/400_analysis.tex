...
\newlength{\manif}
\settowidth{\manif}{\fns Manifestation}
\begin{figure}[ht]
  \centering
  \begin{tikzpicture}[
    >=Latex,
    ...
    \node [below=10mm of Work]  (Expr) {\fns\mystrut\tikzpb[\hspace*{\fill}]{\manif}{\term{Expression}}};
    \node [below=10mm of Expr]  (Mani) {\fns\mystrut\tikzpb[\hspace*{\fill}]{\manif}{\term{Manifestation}}};
    \node [below=10mm of Mani]  (Item) {\fns\mystrut\tikzpb[\hspace*{\fill}]{\manif}{\term{Item}}};
    
    \node [above=10mm of Work,draw=none,fill=none,inner sep=0mm]  (Ende) {\fns\mystrut\tikzpb[\hspace*{\fill}]{\manif}{\term{Endeavour}}};
    \node [fit={(Ende) (Work) (Expr) (Mani) (Item)},fill=none] (G1E) {};
