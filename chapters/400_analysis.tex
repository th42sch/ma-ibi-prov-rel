...
\begin{itemize}
  ...
  \item
    ...
    and the \mybold{union catalogues of \gls{hbz} and \gls{hebis}}
  \item
    catalogues of single libraries, if not covered by any of the above
  \item
    special catalogues, e.g., those used in the \gls{SoNAR} project;\todo{explain; relate to SoNAR or loot research}
    in particular: \\
    \mybold{\gls{ZDB}, \gls{KPE}, \gls{ZEFYS}, ExilePress}
\end{itemize}
