...
%    \node [below= 8mm of Pers] (Corp) {\fns\mystrut\tikzpb[\hspace*{\fill}]{\respe}{\term{CorporateBody}}};
    ...
    \node [below=4mm of $(G1E.south east)!0.50!(G2E.south west)$,draw=none,fill=none,inner sep=.2mm] (SepS) {};
...
%    }%
%  }
  \caption{Basic \gls{FRBR} entities and relations}
  \label{fig:FRBR}
\end{figure}
