...
Until recently, MARC~21 had separate data fields for the recording of provenance features, owners,
...
that provide metadata on objects, individuals, and relationships
...
relevant objects, individuals, and relationships include
works, expressions, manifestations, exemplars,
persons, corporate bodies, ownership, and professional and social relationships.
...
\todo[defer,inline]{DISCUSS HeBIS? 68.. fields, unstructured; provenance feature cannot be linked to owner in case of several provenance entries}
