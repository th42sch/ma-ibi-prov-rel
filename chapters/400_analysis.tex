...
whenever the model and tool that we are going to develop in the following chapters
is implemented in a concrete tool in future work.
...
However, the practice of provenance indexing differs greatly between the two network.
Since 2014, the GBV has been advising the recording on the bibliographic level,
...
\gls{T-PRO} (see Section~\ref{sec:provenance_indexing}). ***
