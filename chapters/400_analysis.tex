...
In order to devise a method for retrieving provenance relationships,
data sources need to be selected. It is the aim of this chapter
to provide a background for this selection.
We therefore review data sources that contain the relevant information
as well as data formats and communication interfaces used in those.
Given the observation from the previous chapters
that answering provenance queries can involve several data sources,
we put a focus on data transfer and integration techniques,
