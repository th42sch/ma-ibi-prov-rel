...
and the standardisation of MARCXML.

In addition to the fragmentation of MARC, several non-MARC formats
started to proliferate. The problem
of standard proliferation can be solved in two ways:
by translation and unification. One tool for unification is Dublin Core, see below.

****** (Turbomarc, MAB2 as a MARC \enquote{family member} \autocite[p.204]{Hider2008})
