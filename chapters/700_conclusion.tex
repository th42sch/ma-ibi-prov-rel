...
Finally, our example queries, as well as some of the requirements from the \gls{SoNAR} project
cannot simply be cast into a graph but instead require more specification or manual exploration.
