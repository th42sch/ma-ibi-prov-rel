...
In particular, since the release of the
...
\todo[inline]{Address \enquote{Raubgut}, items acquired without purchase $\leadsto$ add relevant example queries?}
...
read French editions of English works.\todo{give more concrete example (DH?)}\footnote{from personal communication with Dietrich Hakelberg}
...
\todo[inline]{Further thoughts on example queries:}
%
\begin{itemize}
  \item
