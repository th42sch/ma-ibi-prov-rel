...
For example, the German library networks GBV and SWB maintain and use the common catalogue (database)
...
such as MARC~21 and RDF via several interfaces in the case of \gls{GND}.
...
\footnote{%
  ...
  the links to \gls{ISNI}, \gls{VIAF}, WorldCat und \gls{GND},
