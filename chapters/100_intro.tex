...
read French editions of English works.\todo[ask]{give more concrete example (DH?)}\footnote{from personal communication with Dietrich Hakelberg}
...
\todo[inline,think]{Further thoughts on example queries:}
%
\begin{itemize}
  \item
