...
in data fields at the bibliographic level,
while others use the exemplar level.
...
While \exaquery{2} fixes a relation between persons (\enquote{collaborator} or \enquote{student})
