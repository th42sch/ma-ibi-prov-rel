...
\todo[inline,color=red!30]{Connect questions from library science with methods from mathematics/theoretical computer science $\leadsto$ benefit. Name methods for each SQ above?}
