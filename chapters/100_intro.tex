...
\todo[inline]{elaborate more on provenance research, see again intro in \autocite{Zuschlag2022} \url{https://hu-berlin.hosted.exlibrisgroup.com/permalink/f/uig076/TN_cdi_proquest_ebookcentral_EBC7110151}; highlight importance of \enquote{item histories}}
...
while others use the exemplar level (\enquote{Exemplarebene}, describing held exemplars of the manifestation).
...
and, depending on the specific individual, it may be necessary
...
manifestations, collections, etc. Therefore, \exaquery{1}--\exaquery{9} are actually
query \emph{patterns}, each of which represents a set of possible queries
that can be obtained by instantiating the variables with specific objects.
For the introductory purposes of this chapter,
we continue to use the placeholders and refer to \exaquery{1}--\exaquery{9}
...
When attempting to answer queries such as \exaquery{1}--\exaquery{9},
...
\todo[inline]{Highlight: retrieval system $=$ vision (see begin of §\ref{chap:method})}
