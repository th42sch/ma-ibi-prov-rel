...
After a review of related work (Chapter~\ref{chap:rel_work}),
we will revisit in Chapter~\ref{chap:prototype_queries}
...
This discussion will be used as a point of reference for the subsequent considerations.
\todo{possibly adapt this paragraph later}

In order to answer Questions~\subquestion{1} and~\subquestion{2}, we will review
