...
in \exaquery{2} with the seminal work \emph{De revolutionibus orbium coelestium}
...
\begin{enumerate}
  \item
    ...
    because\todo[ask]{find proof in the lit./with experts? Ask DH?}
    ...
    \todo[inline,think]{Explain this further? A case for ontologies!}
  \item
    ...
    \todo[inline,quick]{get back to \enquote{indirect/substitute information} from SoNAR, see Section~\ref{sec:HNA+SoNAR}}
    ...
    or terms may not be part of the fixed vocabulary for a data field in a source.\todo[ask]{find example? DH?}
...
and each catalogue needs to be queried individually, using its own search functionality and syntax. \todo[think]{give examples of commonalities (OPAC) and differences (discovery vs. OPAC)?}
