...
\todo[inline]{Perhaps \enquote{prototype} is too strong? See explanations in email to Christian Rüter:}

\begin{quote}
  Zur Bedeutung von Q1–Q3: aus meiner Sicht sind das Beispielfragen, anhand derer ich die allgemeine Idee veranschaulichen möchte. Wahrscheinlich ist mein Begriff „Prototyp“ zu stark. Das abstrakte Modell wiederum ist so allgemein, dass es vom konkreten Inhalt der Frage unabhängig ist. Dazu habe ich inzwischen mehr Erläuterungen geschrieben, und ich bin auch gerade bei einer Anforderungsanalyse, die sich aus dem Literaturstudium ergeben hat (v.a. Projekt SoNAR von Frau Petras et al.). Ich habe auch drei Expertinnen um weitere Beispiel-Fragestellungen gebeten, aber in zwei Fällen noch keine Antwort bekommen.
\end{quote}
...
with provenance researchers\todo{ask more experts (V. Petras, M. Hopp, J. Weis)},%
...
Given that this thesis focuses on the technical prerequisites and realisation,
...
\begin{itemize}
  \item
    Discuss instances of \exaquery{1}, \exaquery{3}, \exaquery{4}, or \exaquery{5}?
  \item
    Add further prototypical query patterns?
  \item
    Explain how \exaquery{1}--\exaquery{5} differ from each other (extend remarks from Section~\ref{sec:background})?
\end{itemize}
...
\begin{enumerate}
  ...
  \item
    ...
    \todo[inline]{get back to \enquote{indirect/substitute information} from SoNAR, see Section~\ref{sec:HNA+SoNAR}}
