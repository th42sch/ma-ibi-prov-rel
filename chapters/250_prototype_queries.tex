...
\begin{enumerate}
  \item
    ...
    reveals that GND does have an entry for the subject \enquote{Wissenschaftler} (scientist) \autocite{...}
    which, however, is used only sporadically: its 46 subordinate terms do not include, for example,
    \enquote{Mathematiker}, \enquote{Astronom}, or \enquote{Theologe} (mathematician, astronomer, theologian)  \autocite{...}.
