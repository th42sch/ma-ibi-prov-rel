...
\todo[inline]{!! \enquote{scientist} isn't given in GND for, e.g., Thau -- only more specific relations such as \enquote{mathematician}, \enquote{astronomer}, \enquote{lawyer}. $\Rightarrow$ we need QA with taxonomies/ontologies !!}
