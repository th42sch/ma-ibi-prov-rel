...
\begin{itemize}
  ...
  \item
    special catalogues;
    in particular: \gls{ZDB}, \gls{KPE}, ZeFYS, ExilePress (which have been used in the \gls{SoNAR} project) \todo{explain; relate to SoNAR or loot research} \todo[quick]{take care of abbreviations, also below}
\end{itemize}
