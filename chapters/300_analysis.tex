...
\todo[inline]{GND data accessible via the same interface?}
...
\todo[inline]{temporal data restricted to year of publication or years of birth and death, if available? No temporal attributes on relations (e.g., student, coauthor)}
