...
The following information is taken from the DNB's websites under the category \enquote{DNB Professional} \autocite{DNB_coll_mand,DNB_cataloguing,DNB_metadata}.
...
adhering to standards such as \gls{RDA}, using authority data, and including identifiers such as ISBN, ISSN, URN, and DOI.
...
\begin{itemize}
  \item
    ...
    XML serialisations of the formats MARC~21, RDF, DNB Casual (an XML-based Dublin Core format), MODS\todo{introduce all these abbreviations}
  \item
    \gls{OAI}:
  ...
  \item
    ...
    MARC~21 and RDF in various serialisations, DNB Casual, CSV
\end{itemize}

\todo[inline]{standards for time and date specification, temporal attributes, provenance}
