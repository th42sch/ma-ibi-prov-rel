...
\begin{itemize}
  ...
  \item
    special catalogues;
    in particular: ZDB, KPE, ZeFYS, ExilePress (which have been used in the SoNAR project) \todo{explain; relate to SoNAR or loot research}
\end{itemize}
...
Examples include the \gls{GND} in the German-speaking area (which has been used extensively in SoNAR), and ISNI and VIAF (worldwide).
