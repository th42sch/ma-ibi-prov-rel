...
The \gls{FRBR} comprise an entity-relationship model
...
These entities fall into three groups, of which we restrict ourselves to the first
two.
Entities of \emph{Group~1} are \term{Work}, \term{Expression}, \term{Manifestation}, \term{Item},
and their common superordinate concept \emph{Endeavour};
entities of \emph{Group~2} are \term{Person}, \term{Family}, \term{Corporate body},
and their superordinate concept \emph{Responsible\_entity}.
Furthermore, \gls{FRBR} contains relations that link Group-1 entities with each other
and with Group-2 entities, respectively.
Relations of the first kind are
\term{has\_realisation}, \term{has\_embodiment}, \term{has\_exemplar}, plus
their inverses and the superordinate relations \term{has\_part}, \term{is\_part\_of}, and \term{has\_related\_endevour}).%
\footnote{We slightly deviate from the original names \enquote{realization}, \enquote{embodiment}, etc.\
in order to distinguish relations from concepts and indicate their direction more clearly.}
Relations of the second kind are
\term{has\_creator}, \term{has\_realiser}, \term{has\_creator}, and \emph{has\_owner},
plus their inverses and the superordinate relations \term{has\_responsible\_entity}
and \term{is\_responsible\_entity\_of}.
