...
% .............
\subsubsection{(2) Authority Files}
...
% .............
\subsubsection{(3) Knowledge Bases}

Open knowledge bases contain, among others, data relevant for provenance research.
According to the insights from the \gls{SoNAR} project,
their large data pools may be used to overcome the problem with missing or biased data
in authority files such as the \gls{GND} (see Section~\ref{sec:HNA+SoNAR}).
However, knowledge bases are usually edited by a larger	community with
a less strict quality control.
A prominent example is Wikidata, which has tentatively been used in the context of the \gls{SoNAR} project.

% .............
\subsubsection{(4) Cultural Heritage Databases}
...
and Proveana---the research database at the German Lost Art Foundation \cite{Proveana}.
