...
\todo[inline]{Discuss the choice of this graph-based framework; delineate from classical database theory (text snippets commented out). This argument has to be a logical consequence of the requirement analysis in the previous chapter(s)!}
