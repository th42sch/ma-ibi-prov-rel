...
We begin with data sources---they correspond exactly to our notion of a graph.
%
\begin{definition}
...
\todo[inline,color=red!30]{Continue here: Name advantages of using graph theory as an instrument (modelling power, abstraction, available methods, well-behaved algorithms, ready-to-use implementations); span bridge from concrete example queries to GT; possibly give links to basic (video) tutorials in GT (ask Leif?)}


\todo[inline,caption={}]{%
  Relate this \enquote{machinery} to the prototype queries. In particular:
  %
  \begin{itemize}
    \item
