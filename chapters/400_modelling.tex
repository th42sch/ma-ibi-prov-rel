...
and underlie the Resource Description Framework (RDF) ...,\todo{2 citations} which is a standard of the
...
\todo[inline]{Span bridge from concrete example queries to GT? Possibly give links to basic (video) tutorials in GT (ask Leif?)}
...
\todo[inline]{TODO: Relate this \enquote{machinery} to the prototype queries. In particular:}
%
\begin{itemize}
  \item
