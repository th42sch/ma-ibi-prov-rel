...
\todo[inline,defer]{\enquote{announce} knowledge graphs, state of provenance indexing, further research}
...
\todo[inline,think]{Some more comments on NEL and choice of data sources from \autocite{Menzel2021, Meiners2022}? see Exposé}
...
\end{itemize}
%
In the context of the Semantic Web, there are further technologies related to RDF
which are of interest for the purposes of this thesis:
%
\begin{itemize}
  \item
  ...
  \item
    the \emph{Web Ontology Language OWL} \autocite{***}:
    
    \par
    ...
  \item
    \emph{SPARQL} (Simple Protocol And RDF Query Language) \autocite{***}:
    
    \par
    ...
\end{itemize}

\todo[quick,inline]{OWL, SPARQL}

\todo[quick,inline]{ontologies}
...
\todo[inline]{L(O)D in libraries: quick summary}

\todo[inline]{finally, data integration, from a DB point of view: reference to PoDI book; specifically mention Chapter 14 on data provenance} 
