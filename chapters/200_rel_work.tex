...
\todo[inline]{finally, data integration, from a DB point of view: reference to PoDI book; delineate DB theory from graph-based data} 
...
\autocite{Burrows2021} describe an LOD model that links
...
\autocite{LigiaTriques2022} give an overview of the data collection and integration technology
in the Digital Public Library of America (DPLA), with a focus on
interoperability and challenges for integrated data access.

\autocite{Freire2019} study metadata aggregation in the context of Europeana \cite{Isaac2012},
a web portal of the European Union that provides access to the collections
of over 3000 cultural heritage institutions in Europe.
This case study involved two Dutch institutions as data provider and aggregator,
and aimed at improved discoverability of the data.
...
\todo[inline]{continue reviewing articles from LD folder}
