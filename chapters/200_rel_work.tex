...
The construction of a uniform data source that integrates all the available data
from the heterogeneous sources appears to be an integral part of SoNAR,
according to \citeauthor*{Menzel2020}'s \autocite*{Menzel2020} discussion.
*** advantages
*** disadvantages
*** our decision: \emph{in-place} answering of a query $\leadsto$ no construction of a graph required, but consultation of single repositories \enquote{on the fly} (however, works on \enquote{integrated} graph as well)
\todo{finish this par}
