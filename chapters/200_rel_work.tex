...
\citeauthor{Eckert2013} \autocite*{Eckert2013,Eckert2012}
studies metadata provenance in connection with linked data
in the context of the Europeana portal. ***** \todo{continue}

Metadata provenance on the Web
has been studied
from the beginnings of linked data
\autocite[see, e.g.][]{Hartig2009,Moreau2008,Moreau2008a};
it has also received attention in the classical database domain \autocite[see, e.g.,][Chapter 14]{Doan2012}.
