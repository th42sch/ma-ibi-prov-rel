...
and managed by the highly performant graph database management system Neo4j\todo{cite}.
The original sources comprise an authority file (GND \autocite{GND}),
federated library catalogues (DNB, ZDB, KPE \todo{cite}), and full texts (ZeFYS, Exile Press \todo{cite}).
...
Since the data sources used include full texts, names of people, corporate bodies, or geographical entities
have to be linked to entities in authority files. The use of the underlying technique,
\emph{named entity linking}, is discussed further by \citeauthor*{Menzel2021} \autocite*{Menzel2021}
in this context.

*** CONTINUE WITH §4.2 FROM NOTES

*** Related projects from \autocite[§2.1]{Menzel2021} 
