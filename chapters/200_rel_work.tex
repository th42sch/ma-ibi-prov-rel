...
\todo[inline]{no statistical approach; no visualisation (but enabled) (formulate this after discussing HNA above)}

Further insights from SoNAR described above are relevant for our approach:
The central role of relationships and of temporal aspects in historical research
as well as the hermeneutic approach have to be taken into account.
Furthermore, the importance of the explorative approach to answering general research questions 
is part of our motivation for developing a method for answering specific, local queries
over a combination of data sources---%
this way, researchers can explore the available data in a ........ 

We aim at supporting the explorative approach to answering general research questions 
by enabling 
