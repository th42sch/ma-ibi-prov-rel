...
The GND provides authority data that is
very suitable for recording provenances across institutions;
this is ensured by the structured data model
and the open and collaborative nature of the GND.
The GND has thus become a central instrument for recording
...
Among other things, users need to be able to get an overview
...
*** we learn: use GND; be aware of heterogeneous situation re. library catalogues
...
such as the GND, which are standardised,
...
\todo[think,inline]{elaborate, depending on whether provenance plays a larger role in subsequent chapters}
