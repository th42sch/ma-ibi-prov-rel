...
According to Wikipedia \autocite{WikiDariahDE},
...
Linked data \autocite{W3CLinkedData,Domingue2011} refers to data published on the world wide web that is structured and connected with other data.
Based on a small and uniform set of simple technologies (essentially HTTP URIs and controlled vocabulary terms expressed in RDF serialisation),
