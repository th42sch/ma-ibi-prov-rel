...
% - - - - - - - - - - - - - - - 
\subsection{Graph Technologies for the Analysis of Historical Social Networks Using Heterogeneous Data Sources}
...
% - - - - - - - - - - - - - - - 
\subsection{Insights Relevant for This Work}
...
The construction of a uniform (graph) database that integrates all the available data
...
%are of interest for the purposes of our study:
The following technologies associated with \gls{RDF} and ontologies
...
%the \gls{SQL}, the ISO standard for managing and querying relational databases.
\glsunset{SQL}%
...
%
%\todo[defer,inline]{omit this subsection?}
%
...
%would be a barrier for most users. This aspect is, however, not in the scope of this study
