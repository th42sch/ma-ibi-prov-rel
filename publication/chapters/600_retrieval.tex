...
It is the vision of this study that, ultimately,
...
\begin{wrapfigure}[16]{o}{5.0cm}
  \centering
  \alt{A rectangle "Configuration Phase" with an arrow to a rectangle "Runtime Phase", which contains three smaller rectangles "Query Formulation", "Query Processing", "Answer Presentation", which are connected via a cycle of three arrows.}
  \begin{tikzpicture}[
    >=Latex,
...
A possible alternative to a graphical interface that is worth considering
