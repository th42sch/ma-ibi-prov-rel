...
%\begin{wrapfigure}[10]{o}{5.4cm}
  \centering
  \alt{The graph has 4 nodes for the object "De revolutionibus" and the variables x, y, z. Node x is a circle and labelled "Item"; nodes y,z are diamonds and y is labelled "Scientist". There are 4 edges according to the relations occurring in the query.}
  \begin{tikzpicture}[
    >=Latex,
...
\begin{enumerate}[(1)]
  \item
    The node named \tikzinlinenode{\term{\foreignlanguage{latin}{De\_revolutionibus}}} represents that work;
  \item
